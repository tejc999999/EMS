package jp.spring.boot.ems.admin.controller;
...
public class AdminController {
    ...
    //
    //// DataSource ds =
    // DataSourceBuilder.create().url(form.getDatabaseUrl()).username(form.getDatabaseUsername())
    //        .password(form.getDatabasePassword())
    //        .driverClassName(form.getDatabaseDriver()).build();
